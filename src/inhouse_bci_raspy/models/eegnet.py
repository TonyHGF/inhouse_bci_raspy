"""GitClone EEGNet architecture; accepts [N,C,T,1] and returns class logits.

Source and compatibility patches are recorded in PROVENANCE.json.
"""
...
class SeparableConv2d(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, bias=False):
        ...
        """Initialize the layer/model using the provided architecture and dimension settings."""
    ...
    def forward(self, x):
        ...
        """Apply this layer/model without changing the source computation order."""
...
class DepthwiseConv2d(nn.Conv2d):
    ...
    def _max_norm(self, w):
        ...
        """Return weights with the source implementation max-norm constraint applied."""
...
class EEGNet(nn.Module):
    ...
    """Temporal, depthwise spatial and separable convolution blocks with a classifier."""
    ...
    def __init__(self, config, output_dim=5, n_electrodes=64, device=None):
        ...
        self._batchnorm1 = nn.BatchNorm2d(self.F1, eps=1e-5)
    ...
    def get_name(self):
        ...
        """Return the EEGNet filter-count identifier used in experiment metadata."""
        return self._name
